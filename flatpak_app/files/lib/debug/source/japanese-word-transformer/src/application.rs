...
mod imp {
    ...
    impl gio::subclass::prelude::ApplicationImpl for ExampleApplication {
        fn activate(&self, app: &Self::Type) {
            ...
            app.set_resource_base_path(Some("/online/sashin/japanesewordtransformer/"));
            app.setup_css();
...
impl ExampleApplication {
    ...
    fn setup_css(&self) {
        ...
        provider.load_from_resource("/online/sashin/japanesewordtransformer/style.css");
    ...
    fn show_about_dialog(&self) {
        let dialog = gtk::AboutDialogBuilder::new()
            .program_name("Japanese word transformer")
            .logo_icon_name(config::APP_ID)
            // Insert your license of choice here
            // .license_type(gtk::License::MitX11)
            .website("https://github.com/sashinexists/japanesewordtransformer/")
            .version(config::VERSION)
            .transient_for(&self.get_main_window())
            .modal(true)
            .authors(vec!["sashin".into()])
            .artists(vec!["sashin".into()])
            .build();
    ...
    pub fn run(&self) {
        info!("Japanese word transformer ({})", config::APP_ID);
